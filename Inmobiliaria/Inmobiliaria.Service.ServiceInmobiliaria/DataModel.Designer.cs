...
namespace Inmobiliaria.Service.ServiceInmobiliaria
{
    ...
    /// </summary>
    public partial class INMOBILIARIAEntities : ObjectContext
    {
        #region Constructores
    
        /// <summary>
        /// Inicializa un nuevo objeto INMOBILIARIAEntities usando la cadena de conexión encontrada en la sección 'INMOBILIARIAEntities' del archivo de configuración de la aplicación.
        /// </summary>
        public INMOBILIARIAEntities() : base("name=INMOBILIARIAEntities", "INMOBILIARIAEntities")
        {
        ...
        /// <summary>
        /// Inicializar un nuevo objeto INMOBILIARIAEntities.
        /// </summary>
        public INMOBILIARIAEntities(string connectionString) : base(connectionString, "INMOBILIARIAEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Inicializar un nuevo objeto INMOBILIARIAEntities.
        /// </summary>
        public INMOBILIARIAEntities(EntityConnection connection) : base(connection, "INMOBILIARIAEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// No hay documentación de metadatos disponible.
        /// </summary>
        public ObjectResult<Edificio> msp_getAllEdificio()
        {
            return base.ExecuteFunction<Edificio>("msp_getAllEdificio");
        }
        /// <summary>
        /// No hay documentación de metadatos disponible.
        /// </summary>
        /// <param name="mergeOption"></param>
        public ObjectResult<Edificio> msp_getAllEdificio(MergeOption mergeOption)
        {
            return base.ExecuteFunction<Edificio>("msp_getAllEdificio", mergeOption);
        }
